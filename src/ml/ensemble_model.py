...
class EnsembleModel:
    ...
    def __init__(self, models: dict[str, Any], weights: dict[str, float] | None = None) -> None:
        """
        ...
        if weights is None:
            ...
            n_models = len(models)
            self.weights = dict.fromkeys(models.keys(), 1.0 / n_models)
        else:
    ...
    def set_params(self, **params) -> "EnsembleModel":  # noqa: ANN003
